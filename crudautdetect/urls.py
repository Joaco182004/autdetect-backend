...
urlpatterns = [
    ...
    path('export-infant-patients/<int:id_psychology>/', views.export_infant_patients_excel, name='export_infant_patients_excel'),
    path('export-questionnaires/<int:id_psychology>/', views.export_questionnaires_excel, name='export_questionnaires_excel'),
